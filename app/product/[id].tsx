...
export default function ProductDetail() {
  ...
  // ✅ SECOND BUG FIX: Dynamically filter, isolate, and structure clean image arrays
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        <FadeInView>
          <View style={styles.imageContainer}>
            {/* ✅ SECOND BUG FIX: Render safe image verification logic directly */}
        ...
        <View style={styles.contentSheet}>
          <FadeInView delay={100}>
            ...
            {/* ✅ FIRST BUG FIX: Raw HTML <div> text block successfully eliminated here */}
                ...
                <View style={styles.pickerWrapper}>
                  ...
                  >
                    {product.variants.map((v: any, idx: number) => (
                      <Picker.Item key={idx} label={`${v.label} - ${v.price}`} value={idx} />
                    ))}
                  </Picker>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  pickerWrapper: { borderWidth: 1, borderColor: '#E8F5E9', borderRadius: 14, overflow: 'hidden', backgroundColor: '#F8FDF5' },
